const Line = () => {
  return (
    <section
      className="
        max-[1024px]:px-20 sm:w-full sm:px-5
      md:w-full md:px-20
    ...
    >
      ...
      <div className="p-20 sm:p-10 flex gap-3 bg-[rgba(255,208,31,0.2)] border-[3px] border-[rgba(255,208,31,0.58)] backdrop-blur-sm rounded-[43px]">
        <p className="text-5xl sm:text-2xl text-center font-bold">
